    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="mx-auto max-w-screen-xl">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <h1 class="text-3xl font-bold ml-5 my-5">Books</h1>
                <div
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Synopsis</th>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <img class="mx-auto h-full dark:hidden"
                                            src="https://via.placeholder.com/1200x1200.png?text=image-notfound"
                                            alt="" />
                                    </td>
                                    <td class="px-4 py-3">{{ $book->synopsis }}</td>
                                    <td class="px-4 py-3">{{ $book->category->name }}</td>
                                    <td class="px-4 py-3">{{ $book->author->name }}</td>
                                    <td class="px-4 py-3">Rp.{{ Number::format($book->price, locale: 'id') }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{ $book->name }}-dropdown-button"
                                            data-dropdown-toggle="{{ $book->name }}-dropdown"
                                        ...
                                        <div id="{{ $book->name }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="{{ $book->name }}-dropdown-button">
                                                <li>
                                                    <a href="#"
