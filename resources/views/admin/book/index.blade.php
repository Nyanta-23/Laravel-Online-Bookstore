                            ...
                            @foreach ($books as $book)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{ $book->book_title }}-dropdown-button"
                                            data-dropdown-toggle="{{ $book->book_title }}-dropdown"
                                        ...
                                        <div id="{{ $book->book_title }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 "
                                                aria-labelledby="{{ $book->book_title }}-dropdown-button">
                                                <li>
