        ...
        <div class="mx-auto max-w-screen-xl">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex justify-between mx-10 items-center">
                    <h1 class="text-3xl font-bold my-5">Edit Book</h1>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="book_title" id="book_title"
                                    ...
                                    placeholder="Type product title book" autofocus
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="slug" id="slug"
                                    ...
                                    placeholder="Slug" readonly value="{{ old('slug', $book->slug) }}" required>
                                ...
                                <select id="author"
                                    ...
                                    @foreach ($authors as $author)
                                        <option value="{{ $author->id }}"
                                            {{ old('author_id', $book->author_id) == $author->id ? 'selected' : false }}>
                                            {{ $author->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select id="category"
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                            {{ old('category_id', $book->category_id) == $category->id ? 'selected' : false }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" name="stock" id="stock"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="12" value="{{ old('stock', $book->stock) }}" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="price" id="price"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="$2999" value="{{ old('price', $book->price) }}" required>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea id="synopsis" rows="8" name="synopsis"
                                    ...
                                    placeholder="Your synopsis here" required>{{ old('synopsis', $book->synopsis) }}</textarea>
